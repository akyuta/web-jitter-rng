...
describe('Randomness Quality Sanity Checks', () => {
    ...
    it('should pass basic monobit test interface check', async () => {
        ...
        // Disable health check for small samples as they may not meet interpCount thresholds
        const bytes = await getJitterRandom(16, { healthCheck: false });
    ...
    it('should pass basic runs test interface check', async () => {
        ...
        // Disable health check for small samples
